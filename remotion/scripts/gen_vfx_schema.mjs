...
const OUT_UI = resolve(ROOT, 'dashboard', 'public', 'vfx-schema-ui.js');
...
if (EXPECTED_KINDS.some((k) => !pat.enums.kind.includes(k))) {
  fail('kind enum missing render-level kinds (drift: tile engine vs schema)');
}
if (
...
const uiJs = [
  "'use strict';",
  '// AUTO-GENERATED by scripts/gen_vfx_schema.mjs — DO NOT EDIT. Edit data/vfx-schema.json.',
  '// Browser twin — app.js (VFX Studio prompt) isi se schema-exact enums/whitelist le leta hai.',
  '// Jab tak ye file exist karti hai, prompt jabhi schema se drift nahi kar sakta.',
  '',
  'window.VFX_SCHEMA_UI = ' + JSON.stringify(ui) + ';',
  '',
].join('\n');
...
console.log('  ui     ' + OUT_UI + '  (browser prompt constants)');